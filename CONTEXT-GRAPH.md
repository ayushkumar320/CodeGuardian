...
| ZT   | [doc/ZERO-TOUCH-PLAN.md](doc/ZERO-TOUCH-PLAN.md) | v1.1 plan: one-command activation, risk dashboard, quality analyzer, Groq model tier, Docker container action |
